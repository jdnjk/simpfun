...
#### 本协议是你与“简幻欢”软件的开发者（以下简称“我方”），为使用本软件及服务，你应当阅读并遵守《软件许可及服务协议》（以下简称“本协议”），以及沈阳简幻科技有限公司旗下项目简幻欢的[《服务协议》](https://www.yuque.com/simpfun/sfe/tos)。请你务必审慎阅读、充分理解各条款内容，特别是免除或者限制责任的条款，以及开通或使用某项服务的单独协议，并选择接受或不接受。限制、免责条款可能以加粗等形式提示你注意。
